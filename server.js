...
// Аномалия "redo" на клиенте играет два полных пролёта подряд (каждый — интро+7с полёта) — для неё отдельный, больший таймер.
const COUNTDOWN = 10000, CLOSE = 1000, RUN_MS = 13600, RUN_MS_REDO = 26000, RESULT_MS = 4500;
